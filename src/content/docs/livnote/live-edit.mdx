...
import documentSwitchprotocol from '../../../assets/diagrams/document-switch-protocol.webp';

<Image src={documentSwitchprotocol} alt="Document switch process explained" />
