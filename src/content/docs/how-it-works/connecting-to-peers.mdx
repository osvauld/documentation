...
import connecting from '../../../assets/diagrams/first-time-connection.webp';
import delegated from '../../../assets/diagrams/delegated-connection.webp';
...
<Image src={connecting} alt="First-Time Connection"/>

### Scenario 2: Delegated Connection

<Image src={connecting} alt="Delegated connection"/>
