...
12. The user sends the payload (encrypted credential fields, user ID, and group ID) to the server.
``` json
{
    "groupId": "group_id",
    "memberId": "user_id",
...
15. The server returns the response (success/failure) to the user.
