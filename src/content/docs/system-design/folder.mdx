...
- `access_type`: The type of access the user has to the folder (e.g., "owner", "read").
...
2. An entry is added to the `folder_access` table, granting the creator of the folder an access type of "owner".
